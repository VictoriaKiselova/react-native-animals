...
export default function LoginPage() {
  ...
  const isDisabledLoginButton = Boolean(
      inputValues.errorEmail || inputValues.errorPassword || !inputValues.email || !inputValues.password)
    ...
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <View style={[styles.mainWrapper]}>
        <KeyboardAvoidingView
          ...
          <TouchableOpacity style={[styles.loginBtnContainer, isDisabledLoginButton && {opacity: 0.5}]}
